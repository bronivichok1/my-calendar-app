    ...
    <div className="instruction-container">
      <div className="instruction-card">
        ...
        <div className="step">
            ...
            <div className="step-content">
              <h3>Удаление</h3>
              <p>Для удаления события нажмите на него, в случае отсуствия прав на удаление обратитесь по телефону 364-26-07.</p>
            </div>
          </div>
        ...
        <div className="step">
            ...
            <div className="step-content">
              ...
              <p>Если необходимое время занято, попробуйте записаться в другую комнату, если нету комнат с подходящими временными промежутками обратитесь по телефону 364-26-07.</p>
            </div>
          </div>
          </div>
